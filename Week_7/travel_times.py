with open("travel_time.txt", "w") as travel_time_file:
    travel_time_file.write("walking,5.0,1.0,0.0 \n")
    travel_time_file.write("biking,15.0,3.0,5.0 \n")
...
for mode in speeds_of_travel:
    ...
    table_format = "{:<" + str(longest_ingredient + 2) + "} {:>5.2f} {:>5.2f} {:>5.2f} {:>5.2f} {:>11.2f} {:>7.2f}\n"
